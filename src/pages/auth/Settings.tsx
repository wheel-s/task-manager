...
const Settings:React.FC = ()=> {
  ...
  return (
    <div className=' fixed z-2 items-center   h-full w-full  flex justify-center'>
    <div  className=''>
      <div className ='sm:bg-gray-100 -mt-20  sm:shadow-2xl ring-slate-400 w-[25rem] px-8 py-5 rounded-[15px] mb-10 max-md:w-[21rem]' >
      <div >
        <h1 className=' text-[1.5rem] text-center text-gray-600 font-serif'>Edit your Profile 🦅</h1> 
      </div>
